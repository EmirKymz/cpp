...
//amele edition
ClapTrap::ClapTrap(): _name(""), _hit_p(10), _energy_p(10), _attack_d(0)
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		this->_energy_p -= (int)amount;
		this->_hit_p += (int)amount;
		std::cout << _name << "'s repaired new energy points : " << this->_energy_p;
		std::cout << " and your new hit points : " << this->_hit_p << std::endl; 
	}
}
